...
<p style="font-size: 14px;font-weight:400;line-height:2.0">
...
<p style="font-size: 12px;font-weight:300">
  <img src="/assets/images/momentochroma/momentochroma_moga.gif" alt="momentochroma_demo_moga" style="width: 100%;" class="center">
  <br>
